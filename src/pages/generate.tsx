...
const GeneratePage: NextPage = () => {
  ...
  const colors = ["blue", "red", "green", "ornage"];
    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center px-4">
        <form onSubmit={onSubmitPrompt} className=" flex flex-col gap-5">
          <FormGroup className="mb-4 flex flex-col gap-2">
            <label>Prompt</label>
          ...
          <button
            className="flex h-10 items-center justify-center rounded bg-blue-400 px-2 py-1 hover:bg-blue-600 disabled:bg-gray-600"
